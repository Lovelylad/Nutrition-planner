...
module.exports = class UsersDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.meal_plans_user = await users.getMeal_plans_user({
      transaction,
    });

    output.profiles_user = await users.getProfiles_user({
      transaction,
    });

    output.user_activities_user = await users.getUser_activities_user({
      transaction,
    });
