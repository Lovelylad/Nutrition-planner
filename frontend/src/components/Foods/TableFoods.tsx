...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/foods/foodsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureFoodsCols';
...
const TableSampleFoods = ({
  ...
  useEffect(() => {
    if (foodsNotify.showNotification) {
      notify(foodsNotify.typeNotification, foodsNotify.textNotification);
    }
  }, [foodsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/foods/foods-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {foods && Array.isArray(foods) && !showGrid && (
        <ListFoods
          foods={foods}
          loading={loading}
...
export default TableSampleFoods;
