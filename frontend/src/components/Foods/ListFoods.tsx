...
const ListFoods = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_FOODS');
              ...
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.macronutrients}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>Micronutrients</p>
                    <p className={'line-clamp-2'}>{item.micronutrients}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>ServingSize</p>
                    <p className={'line-clamp-2'}>{item.serving_size}</p>
                  </div>
                </div>
                <ListActionsPopover
                  onDelete={onDelete}
