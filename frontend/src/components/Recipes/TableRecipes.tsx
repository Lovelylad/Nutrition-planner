...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/recipes/recipesSlice';
...
const TableSampleRecipes = ({
  ...
  const handleViewAction = (id: string) => {
    router.push(`/recipes/recipes-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {recipes && Array.isArray(recipes) && !showGrid && (
        <ListRecipes
          recipes={recipes}
          loading={loading}
