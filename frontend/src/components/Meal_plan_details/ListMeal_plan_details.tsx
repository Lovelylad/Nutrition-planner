  ...
  return (
    <>
      <div className='relative overflow-x-auto p-4 space-y-4'>
              ...
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>MealPlan</p>
                    <p className={'line-clamp-2'}>
                      {dataFormatter.meal_plansOneListFormatter(item.meal_plan)}
                    </p>
                  </div>
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.day}</p>
                  </div>
        ...
        {!loading && meal_plan_details.length === 0 && (
...
export default ListMeal_plan_details;
