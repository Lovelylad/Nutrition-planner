...
import { create } from '../../stores/recipe_ingredients/recipe_ingredientsSlice';
...
Recipe_ingredientsNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_RECIPE_INGREDIENTS'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default Recipe_ingredientsNew;
