      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            ...
            <p>{profiles?.age || 'No data'}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>Gender</p>
            <p>{profiles?.gender ?? 'No data'}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>ActivityLevel</p>
            <p>{profiles?.activity_level ?? 'No data'}</p>
          </div>
          ...
          <FormField label='Multi Text' hasTextareaHeight>
            <textarea
              className={'w-full'}
              disabled
              value={profiles?.dietary_restrictions}
            />
          </FormField>
          ...
          {hasPermission(currentUser, 'READ_ORGANIZATIONS') && (
            <div className={'mb-4'}>
              ...
              <p>{profiles?.organization?.name ?? 'No data'}</p>
            </div>
          )}
