...
const ProfilesTablesPage = () => {
  ...
  const [filters] = useState([
    { label: 'DietaryRestrictions', title: 'dietary_restrictions' },
    { label: 'HealthGoals', title: 'health_goals' },
  ...
  const hasCreatePermission =
    currentUser && hasPermission(currentUser, 'CREATE_PROFILES');
      ...
      <SectionMain>
        ...
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          ...
          <div className='md:inline-flex items-center ms-auto'>
            <Link href={'/profiles/profiles-table'}>Switch to Table</Link>
          </div>
        </CardBox>
